      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/contact" className="bg-navy-900 text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-slate-800 transition-all active:scale-95 shadow-lg shadow-navy-900/10">
              Get Started
            </Link>
          </div>
            ...
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="pt-4 px-3">
                <Link 
                  to="/contact" 
                  onClick={() => setIsMenuOpen(false)}
                  className="block w-full bg-brand-600 text-white px-5 py-3 rounded-xl text-center text-base font-semibold"
                >
                  Get Started
                </Link>
              </div>
